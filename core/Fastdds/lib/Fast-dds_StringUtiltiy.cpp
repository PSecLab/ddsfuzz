#include "../include/Fast-dds_StringUtiltiy.h"
...
std::string convert_durability_service_qos_to_string(DurabilityServiceQosPolicy service, int tab_size){
    ...
    result += tab + "<service_cleanup_delay>" + std::to_string(service.service_cleanup_delay.to_ns()) + "</service_cleanup_delay>" + "\n";
...
std::string convert_deadline_qos_to_string(DeadlineQosPolicy deadline, int tab_size){
    ...
    result += tab + "<period>" + std::to_string(deadline.period.to_ns()) + "</period>" + "\n";
...
std::string convert_latency_budget_qos_to_string(LatencyBudgetQosPolicy latency, int tab_size){
    ...
    result += tab + "<duration>" + std::to_string(latency.duration.to_ns()) + "</duration>" + "\n";
...
std::string convert_liveliness_qos_to_string(LivelinessQosPolicy liveliness, int tab_size){
    ...
    result += tab + "<lease_duration>" + std::to_string(liveliness.lease_duration.to_ns()) + "</lease_duration>" + "\n";
...
std::string convert_reliability_qos_to_string(ReliabilityQosPolicy reliability, int tab_size){
    ...
    result += tab + "<max_blocking_time>" + std::to_string(reliability.max_blocking_time.to_ns()) + "</max_blocking_time>" + "\n";
...
std::string convert_lifespan_qos_to_string(LifespanQosPolicy lifespan, int tab_size){
    ...
    result += tab + "<duration>" + std::to_string(lifespan.duration.to_ns()) + "</duration>" + "\n";
...
std::string convert_time_based_filter_qos_to_string(TimeBasedFilterQosPolicy time, int tab_size){
    ...
    result += tab + "<minimum_separation>" + std::to_string(time.minimum_separation.to_ns()) + "</minimum_separation>" + "\n";
...
std::string convert_reader_data_lifecycle_qos_to_string(ReaderDataLifecycleQosPolicy reader, int tab_size){
    ...
    result += tab + "<autopurge_no_writer_samples_delay>" + std::to_string(reader.autopurge_no_writer_samples_delay.to_ns()) + "</autopurge_no_writer_samples_delay>" + "\n";
    result += tab + "<autopurge_disposed_samples_delay>" + std::to_string(reader.autopurge_disposed_samples_delay.to_ns()) + "</autopurge_disposed_samples_delay>" + "\n";
...
DurabilityServiceQosPolicy convert_string_to_durability_service_qos(std::string qos){
    ...
    service.service_cleanup_delay = Duration_t(0, durability_service_delay);
    st = en;
...
DeadlineQosPolicy convert_string_to_deadline_qos(std::string qos){
    ...
    deadline.period = Duration_t(0, deadline_period);
...
LatencyBudgetQosPolicy convert_string_to_latency_budget_qos(std::string qos){
    ...
    latency.duration = Duration_t(0, latency_duration);
...
LivelinessQosPolicy convert_string_to_liveliness_qos(std::string qos){
    ...
    liveliness.lease_duration = Duration_t(0, liveliness_duration);
    liveliness.announcement_period = Duration_t(0, liveliness_duration * 0.6);
...
ReliabilityQosPolicy convert_string_to_reliability_qos(std::string qos){
    ...
    reliability.max_blocking_time = Duration_t(0, reliability_max_blocking_time);
...
LifespanQosPolicy convert_string_to_lifespan_qos(std::string qos){
    ...
    lifespan.duration = Duration_t(0, lifespan_duration);
...
TimeBasedFilterQosPolicy convert_string_to_time_based_filter_qos(std::string qos){
    ...
    filter.minimum_separation = Duration_t(0, time_based_filter_minimum_separation);
...
ReaderDataLifecycleQosPolicy convert_string_to_reader_data_lifecycle_qos(std::string qos){
    ...
    lifecycle.autopurge_no_writer_samples_delay = Duration_t(0, reader_no_writer);
    st = en;
    ...
    lifecycle.autopurge_disposed_samples_delay = Duration_t(0, reader_disposed);
